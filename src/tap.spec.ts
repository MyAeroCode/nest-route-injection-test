...
tap.test('sinon: GET api/hello should call spy function', async (test) => {
...
tap.test('sinon: POST api/hello sholud call spy function', async (test) => {
    const { agent, helloWithBodySpy, helloWithParamSpy, helloWithQuerySpy } = await initSinon();
...
tap.test('sinon: POST api/hello/:userName sholud call spy function', async (test) => {
    const { agent, helloWithBodySpy, helloWithParamSpy, helloWithQuerySpy } = await initSinon();
...
tap.test('mockito: GET api/hello should call spy function', async (test) => {
...
tap.test('mockito: POST api/hello sholud call spy function', async (test) => {
    const { agent, appControllerSpy } = await initMockito();
    const res = await agent.post('/api/hello').send({ userName });
    test.is(res.status, 201);
    test.is(res.text, expected);
...
tap.test(`mockito: POST api/hello/:userName sholud call spy function`, async (test) => {
    const { agent, appControllerSpy } = await initMockito();
    const res = await agent.post(`/api/hello/${userName}`);
    test.is(res.status, 201);
    test.is(res.text, expected);
...
tap.test('testdouble: GET api/hello should call stub function', async (test) => {
...
tap.test('testdouble: POST api/hello sholud call stub function', async (test) => {
    const { agent } = await initTestdouble();
    const res = await agent.post('/api/hello').send({ userName });
    test.is(res.status, 201);
...
tap.test(`testdouble: POST api/hello/:userName sholud call stub function`, async (test) => {
    const { agent } = await initTestdouble();
    const res = await agent.post(`/api/hello/${userName}`);
    test.is(res.status, 201);
